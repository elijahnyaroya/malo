...
import 'package:africa_women_in_europe/connect/loader.dart';
...
class PastEvents2 extends StatelessWidget {
  @override
...
class pastevents2 extends StatefulWidget {
  @override
  _pastevents2State createState() => _pastevents2State();
}

class _pastevents2State extends State<pastevents2> {


  Future<List<Groups>>_getUsers() async {
    var data = await http.get(URL_CONNECTOR+"pulleventpast.php");
