...
class Attendance extends StatefulWidget {
  ...
  const Attendance({Key key, this.events_id, this.events_date, this.events_venue, this.events_eventname, this.page_from}) : super(key: key);
...
class _AttendanceState extends State<Attendance> {
  Future<List<Data>>_getData() async {
    final data = await http.post(URL_CONNECTOR + "pullevents_attendees.php", body: {
    ...
    for (var u in jsonData) {
      Data datas = Data(u["id"], u[ "name"], u["title"], u["imageprof"],u["user_id"]);
            ...
            child: ListView(
              ...
              children: <Widget>[
                ...
                GestureDetector(
                    ...
                    child: Text("ATTENDANCES",style: TextStyle(color: Colors.white,fontSize: 17.0))),
                SizedBox(width: 10.0,),
                SizedBox(width: 2.0,
                  child: Container(
                    width: 2.0,
...
class Data{
  ...
  Data(this.id, this.name, this.title, this.imageprof,this.user_id);
