...
import 'package:africa_women_in_europe/eventstab/moreevents/Speakersevent.dart';
...
import 'moreevents/attendances.dart';


class EventsExpands extends StatefulWidget {
  final events_id;
  final events_date;
  final events_venue;
  ...
  const EventsExpands({Key key, this.events_id, this.events_date, this.events_venue, this.events_eventname, this.page_from}) : super(key: key);



  @override
  _EventsExpandsState createState() => _EventsExpandsState();
}

class _EventsExpandsState extends State<EventsExpands> {
              ...
              children: <Widget>[
                SizedBox(width: 10.0,),
                 GestureDetector(
                     ...
                     child: Text("INFO",style: TextStyle(color: Colors.white,fontSize: 17.0),)),
                SizedBox(width: 10.0,),
                SizedBox(width: 2.0,
                  child: Container(
                    width: 2.0,
